...
public class SimplePitchRoll extends View {
    ...
    public SimplePitchRoll(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try{
            ...
            /*Pitch properties */
            mPitchMin = attributes.getFloat(R.styleable.SimplePitchRoll_pitchMin, NORMALIZED_PITCH_LOWER_BOUND);
            mPitchMax = attributes.getFloat(R.styleable.SimplePitchRoll_pitchMax, NORMALIZED_PITCH_UPPER_BOUND);
            mPitch = attributes.getFloat(R.styleable.SimplePitchRoll_pitch, (mPitchMax + mPitchMin) / 2);
